...
textarea {font-size:1.17rem !important; line-height:1.5 !important; padding:20px !important; background-color:#fff6e9 !important; color:#7a4d00 !important; border-radius:16px !important; border:2px solid #ffaf52 !important; box-shadow:none !important; transition:border-color 0.3s ease, background-color 0.3s ease; min-height:110px !important; resize:vertical !important;}
...
.copy-btn {position:absolute; right:18px; top:18px; background:#ff7f23; color:white; border:none; border-radius:10px; padding:4px 10px; cursor:pointer;}
