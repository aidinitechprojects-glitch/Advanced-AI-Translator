...
/* Glass Card */
.pro-glass {background:rgba(255,255,255,0.91);border-radius:28px;
            box-shadow:0 12px 56px 0 #bf7cf328, 0 0.5px 2px #00000012;
            padding:38px 38px 30px 38px;margin:28px 0 0 0;}

/* Header */
.pro-header {display:flex;align-items:center;justify-content:space-between;margin-bottom:0;}
.pro-title {font-size:2.4rem;font-weight:900;letter-spacing:.03em;
            background:linear-gradient(90deg,#ff7a18,#af002d 70%);
            -webkit-background-clip:text;-webkit-text-fill-color:transparent;}
.pro-badge {font-size:1.05rem;background:linear-gradient(90deg,#af002d,#ff7a18 95%);
            color:#fff;border-radius:8px;padding:4px 20px;margin-left:16px;font-weight:500;
            box-shadow:0 1px 7px #af002d22;}
.pro-subtitle {font-size:1.13rem;color:#2b2542;font-weight:500;text-align:left;margin-bottom:24px;margin-top:4px;}

/* Textarea Input */
textarea {background:rgba(255,245,230,0.97)!important;border-radius:19px!important;
          font-size:1.11rem;color:#222!important;border:2px solid #ffd6b7!important;
          box-shadow:0 4px 24px #ff7a1812;}
textarea:focus {border:2.5px solid #ff7a18!important;background:#fff9f0!important;}

/* Swap Button */
.pro-swap-btn {width:44px;height:44px;background:linear-gradient(90deg,#3a86ff,#ff7a18);
               color:#fff;border-radius:50%;font-size:1.25rem;border:none;
               display:flex;align-items:center;justify-content:center;
               box-shadow:0 4px 20px #ff7a1810;transition:filter .2s;}
.pro-swap-btn:hover {filter:brightness(1.13);}

/* Translate Button */
.pro-btn {width:100%;padding:.7em 0;margin-top:13px;
          background:linear-gradient(90deg,#af002d,#ff7a18 75%);
          color:#fff;border:none;border-radius:13px;font-size:1.17rem;font-weight:bold;
          box-shadow:0 5px 18px #ff7a1825;transition:filter .18s,box-shadow .13s;}
...
/* Upgrade CTA */
.upgrade-cta {margin-top:13px;text-align:center;background:linear-gradient(90deg,#ff7a18,#af002d 85%);
              color:#fff;font-size:1.09rem;font-weight:700;border-radius:13px;padding:8px 0 7px 0;
              box-shadow:0 4px 14px #ff7a1817;}
</style>
...
""", unsafe_allow_html=True)
st.markdown("<div class='pro-subtitle'>Translate text across languages with phonetics & audio playback.</div>", unsafe_allow_html=True)
